  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-white">
      ...
      <main className="flex-1 p-8">
        <h1 className="text-3xl font-bold bg-gradient-to-br from-amber-400 to-yellow-600 bg-clip-text text-transparent mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white p-6 rounded-xl shadow-lg border border-zinc-700">
            <h2 className="text-lg font-bold bg-gradient-to-br from-amber-400 to-yellow-600 bg-clip-text text-transparent mb-8">
          ...
          <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white p-6 rounded-xl shadow-lg border border-zinc-700">
            ...
            <div className="text-sm text-white/70">
              ...
              <br />
              <button className="mt-4 bg-gradient-to-br from-amber-400 to-yellow-600 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded">
                Conectar via Pluggy
              </button>
            </div>
          </div>
